...
export const metadata: Metadata = { title: "Insights - Growth, Marketing & AI for Businesses", description: "Practical growth, marketing and AI automation insights for Indian businesses from QARO in Kota, Rajasthan.", alternates: { canonical: "/insights" } };
