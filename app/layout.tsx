...
export const metadata: Metadata = {
  ...
  title: { default: "Digital Marketing & Growth Agency in Kota | QARO", template: "%s | QARO" },
  description: "QARO is a growth partner in Kota combining website design, marketing, SEO and AI automation into one connected system.",
  applicationName: "QARO",
  alternates: { canonical: "/" },
  openGraph: {
    type: "website", locale: "en_IN", siteName: "QARO", url: base,
    title: "QARO - Growth, Built Smarter.",
    description: "Design, technology, marketing and automation in one growth system.",
    images: [{ url: "/qaro-growth-engine.webp", width: 1586, height: 992, alt: "QARO connected growth engine" }]
  },
  twitter: { card: "summary_large_image", title: "QARO - Growth, Built Smarter.", description: "One connected growth system for ambitious businesses.", images: ["/qaro-growth-engine.webp"] },
...
const organization = {
  ...
  name: "QARO",
  url: base,
  description: "A growth partner connecting strategy, design, technology, marketing and AI automation.",
